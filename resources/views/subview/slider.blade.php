<h3 class="m_1">New Arrival</h3>
            ...
            @for($i=0 ; $i < 3 ; $i++ )
              ...
              <div class="slide"><a href=""><img src="{!! asset('surfhouse/pro_images/men/T-shirt/ts6.jpg') !!}" height="250"></a></div>
              <div class="slide"><a href=""><img src="{!! asset('surfhouse/pro_images/women/saari/sr6.jpg') !!}" height="250"></a></div>
              <div class="slide"><a href=""><img src="{!! asset('surfhouse/pro_images/men/T-shirt/ts8.jpg') !!}" height="250"></a></div>
