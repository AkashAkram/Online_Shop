...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <!-- Branding Image -->
            <a class="navbar-brand height" href="{{ url('/') }}">
                AK Mart
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="height" href="{{ url('/cart') }}"><span class="fa fa-remove"></span>Cart</a></li>
                <!-- Authentication Links -->
                @if (Auth::guest())
                    <li><a class="height" href="{{ url('/login') }}">Login</a></li>
                    <li><a class="height" href="{{ url('/register') }}">Register</a></li>
                @else
                <li><a class="height" href="{{ url('/add') }}">Add product</a></li>
                    <li class="">
                        <a class="height" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
